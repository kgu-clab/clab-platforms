...
export const buttonVariants = cva({
  base: 'rounded-lg border text-sm font-semibold transition-colors duration-300 ease-in-out',
  variants: {
    color: {
      primary: 'border-clab-primary text-clab-primary hover:bg-clab-primary/20',
      secondary:
