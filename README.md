...
- [member](https://github.com/KGU-C-Lab/clab-platforms/blob/main/apps/member/README.md): 구성원의 활동과 커뮤니케이션을 지원하는 인터널(Internal) 플랫폼이에요.
...
- [design-system (CDS)](https://github.com/KGU-C-Lab/clab-platforms/blob/main/packages/design-system/README.md): 일관성 있는 UI&UX를 위한 디자인 시스템이에요.
